...
The problem statement for this tutorial is given below
   ...
   <p align="center" style="padding: 10px">
    <img alt="Forwarding" src="https://github.com/gokul-pv/AdvancedConvolutions/blob/main/images/problem_statement.png?raw=true" width =700>
    <br>
...
The **summary** of the model is shown below
  ...
  <p align="center" style="padding: 10px">
    <img alt="Forwarding" src="https://github.com/gokul-pv/AdvancedConvolutions/blob/main/images/model_summary.png?raw=true" width =1000>
    <br>
...
The transformation is applied using library albumentations.
  ...
  <p align="center" style="padding: 10px">
    <img alt="Forwarding" src="https://github.com/gokul-pv/AdvancedConvolutions/blob/main/images/Albumentations.png?raw=true" width =1000>
    <br>
...
The training log for epoch 17 to 40 is shown below
 ...
 <p align="center" style="padding: 10px">
    <img alt="Forwarding" src="https://github.com/gokul-pv/AdvancedConvolutions/blob/main/images/training_log_1724.png?raw=true" width =700>
    <br>
    <em style="color: grey">Figure 4.1 : Log1</em>
  </p>
   <p align="center" style="padding: 10px">
    <img alt="Forwarding" src="https://github.com/gokul-pv/AdvancedConvolutions/blob/main/images/training_log_2533.png?raw=true" width =700>
    <br>
    <em style="color: grey">Figure 4.2 : Log2</em>
  </p>
   <p align="center" style="padding: 10px">
    <img alt="Forwarding" src="https://github.com/gokul-pv/AdvancedConvolutions/blob/main/images/training_log_3340.png?raw=true" width =700>
    <br>
...
The test and validation loss and accuracy are shown below
 ...
 <p align="center" style="padding: 10px">
    <img alt="Forwarding" src="https://github.com/gokul-pv/AdvancedConvolutions/blob/main/images/loss_acc_plot.png?raw=true" width =700>
    <br>
    <em style="color: grey">Figure 5 : Loss and accuracy plots</em>
  </p>

   <p align="center" style="padding: 10px">
    <img alt="Forwarding" src="https://github.com/gokul-pv/AdvancedConvolutions/blob/main/images/Class_accurarcy.png?raw=true" width =1000>
    <br>
...
Misclassified images during validation for all the three models are shown below
  ...
  <p align="center" style="padding: 10px">
    <img alt="Forwarding" src="https://github.com/gokul-pv/AdvancedConvolutions/blob/main/images/misclassified.png?raw=true" width =700>
    <br>
